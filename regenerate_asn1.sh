...
asn1extractor/asn1extractor.sh ApplicationDataModule \
  ...
  com.saicmotor.telematics.tsgp.otaadapter.mp.v2_1.entity.vehicle.OTA_RVMVehicleClassifiedStatusReq \
  com.saicmotor.telematics.tsgp.otaadapter.mp.v2_1.entity.vehicle.OTA_RVMVehicleClassifiedStatusResp25857 \
